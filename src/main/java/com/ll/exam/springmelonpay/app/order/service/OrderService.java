package com.ll.exam.springmelonpay.app.order.service;
...
import com.ll.exam.springmelonpay.app.order.repository.OrderRepository;
...
public class OrderService {
    ...
    public void payByRestCashOnly(Order order) {
        ...
        memberService.addCash(buyer, payPrice * -1, "주문결졔__예치금결제");
    ...
    public Optional<Order> findFromPrintById(long id) {
        return findById(id);
    }
